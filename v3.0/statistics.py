...
today_treate = soup.select_one("body > div > div.mainlive_container > div.container > div > div.liveboard_layout > div.liveNumOuter > div > ul > li:nth-child(2) > span.before").text[3:-1]
...
today_definite = soup.select_one("body > div > div.mainlive_container > div.container > div > div.liveboard_layout > div.liveNumOuter > ul > li:nth-child(1) > span.data1").text
today_treat = soup.select_one("body > div > div.mainlive_container > div.container > div > div.liveboard_layout > div.liveNumOuter > ul > li:nth-child(2) > span.data2").text
...
print('완치환자 : '+definite)
print('치료 중 환자 : '+treat)
print('오늘 확진환자 : '+today_definite)
print('오늘 완치환자 : '+today_treate)
print('오늘 사망 환자 : '+today_death)
print('사망 : '+death)
print('누적 검사 수 : '+check)
